...
namespace TurboVision.Dialogs
{
    ...
    {
        private static char[] CDateInput = ("\x13\x13\x14\x15").ToCharArray();
        ...
        public override object[] GetData()
        {
            try
            {
                return new object[1] { new DateTime(Year, Month, Day) };
            }
            catch
            {
        ...
        public DateInput( Rect R):base(R)
        {
        ...
        public override void Draw()
        {
            ...
            B.FillStr(DisplayString, (char)GetColor(1), 0);
