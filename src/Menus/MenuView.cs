...
namespace TurboVision.Menus
{
	...
	public class MenuView : View
	{
		...
		private static char[] CMenuView = ("\x02\x03\x04\x05\x06\x07").ToCharArray();
			...
			uint AHelpCtx, MenuItem Next)
		{
			...
			if( ( Name != "") && ( Command != 0))
			{
				...
				P.Name = Name;
				P.Command = Command;
				P.Disabled = false/*MenuEnabler.CommandEnabled( Command)*/;
				P.KeyCode = KeyCode;
				P.HelpCtx = AHelpCtx;
				P.Param = Param;
				return P;
